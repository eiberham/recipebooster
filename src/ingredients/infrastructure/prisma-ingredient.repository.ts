...
import { Ingredient, CreateIngredientData, UpdateIngredientData } from '../domain/ingredient.interface';
...
export class IngredientRepositoryImpl implements IngredientRepository {
    ...
    async update(id: number, ingredient: UpdateIngredientData): Promise<Ingredient> {
